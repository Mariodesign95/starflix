...
const builder = new addonBuilder({
    id: 'org.Fannub.starflix',
    version: '1.0.0',
    name: 'Starflix',
    description: 'Italian Streaming Addon by Fannub',
    catalogs: [],
    resources: ['stream'],
...
app.get('/', (req, res) => {
    ...
    <body>
        ...
        <div class="footer">
            Powered by <a href="https://github.com/Mariodesign95/" target="_blank">Fannub</a>
        </div>
